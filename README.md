...
The dApp provides a 4-step command center. You must have **MetaMask** installed to interact. The application will automatically prompt you to switch to the GenLayer Studio network.
...
2. **Submit Content**: Enter the Campaign ID and Bounty Index (usually `0`). Paste the public URL of your published work (e.g., a GitHub Gist or public web article). Click **Submit for Review**.
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/dorinalunar/vericampaign-escrow-dapp.git](https://github.com/dorinalunar/vericampaign-escrow-dapp.git)
